<div style="display: none">
	...
	<a class="btn_permiso btn_permiso_reenvio" data-numero-control="" data-estados="1,3" title="Reenvio de factura a hacienda" href="{{url(Request::url().'/reenvio_hacienda/permiso_data_id')}}">
